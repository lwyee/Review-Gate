...
$ExtensionFile = Join-Path $ScriptDir "cursor-extension\review-gate-v2-2.6.2.vsix"
if (Test-Path $ExtensionFile) {
    ...
    Write-ColorOutput "4. Select: $ReviewGateDir\review-gate-v2-2.6.2.vsix" "White"
...
Write-ColorOutput "   • Extension: $ReviewGateDir\review-gate-v2-2.6.2.vsix" "White"
